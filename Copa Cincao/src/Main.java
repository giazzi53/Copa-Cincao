...
public class Main {
    ...
    public static void main(String[] args){
        ...
        int partidasJogadasGrupos = 0; //variavel usada para contar as partidas jogadas, permitindo ou nao passar de fase
                   ...
                   for(int a = 0; a < copa.getNumGrupos(); a++){
                        for(int b = 0; b < copa.getNumJogGrupo(); b++){
                            if(op2 == copa.getGrupo(b).getJogo(a).getNumJogo()){
                                if("".equals(copa.getGrupo(b).getJogo(a).getPlacar())){ //se o placar for vazio, coloque o placar                                  System.out.println("\nDefinindo placar para o jogo " + op2 + ": " + copa.getGrupo(b).getJogo(a).getJogo());
                                    ...
                                    partidasJogadasGrupos ++;
                                    copa.setPartidasJogadasGrupos(partidasJogadasGrupos);
                                } else{
